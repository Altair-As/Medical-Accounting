...
namespace WebApplicationAuth.Data.Migrations
{
    ...
    [Migration("20230427175509_RecordsTableModifiedAgain")]
    partial class RecordsTableModifiedAgain
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplicationAuth.Data.Identity.ApplicationIdentityUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApplicationAuth.Models.Record", b =>
                {
                    ...
                    b.Property<DateTime>("AppointmentDade")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("Date");
                    ...
                    b.Property<int>("MedicalCardNumberId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MedicalCardNumberId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApplicationAuth.Data.Identity.ApplicationIdentityUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApplicationAuth.Data.Identity.ApplicationIdentityUser", b =>
                {
                    b.HasOne("WebApplicationAuth.Models.Employer", "Employer")
                        .WithOne("ApplicationIdentityUser")
                        .HasForeignKey("WebApplicationAuth.Data.Identity.ApplicationIdentityUser", "EmployerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplicationAuth.Models.Record", b =>
                {
                    ...
                    b.HasOne("WebApplicationAuth.Models.MedicalCard", "MedicalCardNumber")
                        .WithMany("Records")
                        .HasForeignKey("MedicalCardNumberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MD");

                    b.Navigation("MedicalCardNumber");
                });
